function skewedell(tp,col,or,x,y); 
...
Screen('DrawLine',tp,colvalue,xpos,ypos+lgth-6,xpos+lgth,ypos+lgth-6,width);
    case 2 % up right    
Screen('DrawLine',tp,colvalue,xpos+6,ypos,xpos+6,ypos+lgth,width);
...
Screen('DrawLine',tp,colvalue,xpos,ypos+6,xpos+lgth,ypos+6,width);        
    case 4 % down left
Screen('DrawLine',tp,colvalue,xpos+lgth-6,ypos,xpos+lgth-6,ypos+lgth,width);
